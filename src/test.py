...
flags = tf.app.flags
flags.DEFINE_string('model_root', '/home/project/project/stereo-magnification',
                    'Root directory for model checkpoints.')
flags.DEFINE_string('model_name', 'babydata-10',
...
flags.DEFINE_string('cameras_glob', '/home/project/project/dataset/test/csvfiles/*.txt',
                    'Glob string for test set camera files.')
flags.DEFINE_string('image_dir', '/home/project/project/dataset/test', 'Path to test image directories.')
flags.DEFINE_integer('random_seed', 8964, 'Random seed')
flags.DEFINE_string('output_root', 'out',
