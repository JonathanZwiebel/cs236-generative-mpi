...
flags = tf.app.flags
flags.DEFINE_string('checkpoint_dir', 'babytrain',
                    'Location to save the models.')
flags.DEFINE_string('cameras_glob', '../dataset/train/csvfiles/*.txt',
                    'Glob string for training set camera files.')
flags.DEFINE_string('image_dir', '../dataset/train',
...
flags.DEFINE_integer('max_steps', 15, 'Maximum number of training steps.')
flags.DEFINE_integer('summary_freq', 1, 'Logging frequency.')
flags.DEFINE_integer(
    'save_latest_freq', 5, 'Frequency with which to save the model '
